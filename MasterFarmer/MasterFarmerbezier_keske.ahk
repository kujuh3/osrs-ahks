...
Random, Thief1x, 5, 20
Random, Thief1y, 5, 20 
Random, RandTimeThieving, 50, 100
...
PixelSearch, Seeditx, Seedity, 576, 198, 754, 443, 0X0000FF, 1, Fast
	if (ErrorLevel =0) {
	MouseGetPos, xpos, ypos
    RandomBezierSeeds(xpos, ypos, Seeditx+Seedx, Seedity+Seedy, "T" RandTimeSeeds "OT10 OB10 OL10 OR10")
	Send {Shift Down}
	Click
	Send {Shift Up}
	}
...
PixelSearch, Px, Py, 542, 345, 559, 351, 0X0000FF, 150, Fast
	if (ErrorLevel != 0) {
	GoTo, EatFood
	}
		else {
...
EatFood:
Random, StunSafeSleep, 2000, 2500
...
PixelSearch, BankBoothx, BankBoothy, 9, 259, 529, 503, 0X00FFFF, 1, Fast
	if (ErrorLevel =0) {
	Random, x3, 0, 8
	Random, y3, 0, 8
...
PixelSearch, Px, Py, 368, 326, 398, 357, 0X1D1F83, 10, Fast
	if (ErrorLevel =0) {
	MouseGetPos, xpos, ypos
	RandomBezier(xpos, ypos, 464+x4, 340+y4, "T" RandTimeDeposit "OT10 OB10 OL10 OR10")
	Click
	MouseGetPos, xpos, ypos
...
PixelSearch, Lobox, Loboy, 576, 198, 754, 443, 0X4DFF00, 1, Fast
	if (ErrorLevel =0) {
	MouseGetPos, xpos, ypos
	RandomBezier(xpos, ypos, 635+x5, 89+y5, "T" RandTimeNPC "OT50 OB50 OL50 OR50")
	Click
	GoTo, FailSafeDropping
	}
	else {
